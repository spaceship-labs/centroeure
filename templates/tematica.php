	<div class="con-info-blanco" layout="row" layout-align="center center" flex="100">	
		<div class="max-widht2  wow bounceInUp" layout="column">
			...
			<p class="text">
				La organización de la biblioteca debe responder a <strong> necesidades prácticas de los proyectos </strong> que se desarrollan en la oficina y <strong> a formatos de consulta </strong> y préstamo in situ fáciles de operar. Por ello, los temas propuestos corresponden a espacios físicos en la biblioteca y a una identificación por color de cada TEMA CENTRAL con tonalidades y/o tramas que permitan regresar el texto consultado al sitio que le corresponde.
			</p>
		</div>
	</div>
